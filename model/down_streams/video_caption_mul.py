...
class OPTForVideoCaptionEnsemble(VLABForPretraining):
    ...
    def forward(self, batch, unfinished, state=None, video_feat=False):
        ...
        return self.generate_caption(batch, unfinished, state), batch
    
    def generate_caption(self, batch, unfinished, state=None ,mode=None):
